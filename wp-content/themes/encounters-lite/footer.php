		...
		<div class="container-fluid">	
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<?php esc_attr_e('Copyright &copy;', 'encounters-lite'); ?> <?php esc_attr_e(date('Y')); ?> <?php echo get_theme_mod( 'site_copyright', 'Your Name' ); ?><?php esc_attr_e('. All rights reserved.', 'encounters-lite'); ?>           
				</div>
			</div>
		</div>
	</div>
