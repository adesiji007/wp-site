...
function encounters_lite_sanitize_blogstyle( $input ) {
    $valid = array(
		'blogright' => __( 'Blog with Right Sidebar', 'encounters_lite' ),
		'blogleft' => __( 'Blog with Left Sidebar', 'encounters_lite' ),
		'blogleftright' => __( 'Blog with Left &amp; Right Sidebar', 'encounters_lite' ),
		'blogwide' => __( 'Blog with Full Width &amp; no Sidebars', 'encounters_lite' ),
    );
